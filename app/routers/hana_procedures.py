...
def call_sp_snbrs_11(input_data: SNBRNS11Input, client: HanaClient = Depends(get_hana_client)):
    try:
        result = client.call_procedure_with_outputs("SP_SNBRS_11", [input_data.param1, input_data.param2])
        output_params = result.get("output_params")
        result_sets = result.get("result_sets", [])
        response = {
            "success": False,
...
def call_sp_snbrs_18(input_data: SNBRNS18Input, client: HanaClient = Depends(get_hana_client)):
    try:
        result = client.call_procedure_with_outputs("SP_SNBRS_18", [input_data.param1, input_data.param2])
        output_params = result.get("output_params")
        result_sets = result.get("result_sets", [])
        response = {
            "success": False,
